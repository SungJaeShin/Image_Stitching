...
cv::Mat calcROIImg(cv::Mat img, cv::Mat H, double &x_diff, double &y_diff)
{
    ...
    double x_min = std::min({H_pt1.at<double>(0,0), H_pt2.at<double>(0,0), H_pt3.at<double>(0,0), H_pt4.at<double>(0,0)});
    double x_max = std::max({H_pt1.at<double>(0,0), H_pt2.at<double>(0,0), H_pt3.at<double>(0,0), H_pt4.at<double>(0,0)});
    double y_min = std::min({H_pt1.at<double>(1,0), H_pt2.at<double>(1,0), H_pt3.at<double>(1,0), H_pt4.at<double>(1,0)});
    double y_max = std::max({H_pt1.at<double>(1,0), H_pt2.at<double>(1,0), H_pt3.at<double>(1,0), H_pt4.at<double>(1,0)});
...
cv::Mat convertcvWarpPlane(cv::Mat img, cv::Mat H)
{
    ...
    cv::Mat warpImg = calcROIImg(img, H, x_diff, y_diff);
...
cv::Mat convertWarpPlane(cv::Mat img, cv::Mat H)
{
    ...
    double x_diff = std::fabs(x_max - x_min);
    double y_diff = std::fabs(y_max - y_min);
    cv::Mat warpImg(y_diff, x_diff, img.type(), cv::Scalar(0,0,0));
